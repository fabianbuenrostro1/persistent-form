...
`}
    >
      ...
      <div className="relative z-10 p-4 md:p-6 pt-2 flex items-center justify-between mt-auto">
        {inventoryCount ? (
          <div className={`
...
`}>
    ...
    String(inventoryCount) !== "0" && String(inventoryCount) !== "..." ? "bg-green-500 animate-pulse" : "bg-gray-300"
} `} />
      ...
      {selected && (
         <div className="absolute top-2 right-2 md:top-4 md:right-4 text-[#1e3a1e] animate-zoom-in z-20 bg-white/50 rounded-full p-1 backdrop-blur-sm">
